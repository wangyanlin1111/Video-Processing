...
class UnifiedVoice(nn.Module):
    ...
    async def inference_speech(self, speech_condition, text_inputs, emo_speech_condition=None, cond_lengths=None, emo_cond_lengths=None, emo_vec=None, use_speed=False, max_mel_tokens=None):
        ...
        # 如果指定了 max_mel_tokens，创建自定义 SamplingParams 控制生成长度
        if max_mel_tokens is not None:
            sampling_params = copy.deepcopy(self.sampling_params)
            sampling_params.max_tokens = max_mel_tokens
        else:
